...
# My variables
HDF5_DATA_FILE = "/kaggle/working/input/myffily/data.hdf5"
HDF5_DATA_FILE_FRAMESKIPPED = "/kaggle/working/input/myffily/data_frameskipped.hdf5"
ACTION_CENTROIDS_FILE = "/kaggle/working/input/myffily/action_centroids.npy"
